...
urlpatterns = [
    ...
    path('posts/<int:id>/comments/new/', views.CommentCreateView.as_view(), name="create_comment"),
    path('posts/<int:post_id>/comment/<int:pk>/edit', views.CommentUpdateView.as_view(), name="comment_edit"),
